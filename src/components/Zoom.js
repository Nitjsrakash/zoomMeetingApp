...
const ZOOM_APP_KEY = "REsipq5aqoRAtVesoUWKGPRfsE35qUs2c1bj";
const ZOOM_APP_SECRET = "jIdtybMDIhmiLpwwRxai52H9hIWDOAPwrEkb";
const ZOOM_JWT_APP_KEY = "z2heEapnTsmbyoX5xljU0Q";
const ZOOM_JWT_APP_SECRET = "mrxAkCuXIl8dvReChh9cPBDE2mzSyFoZEGtZ";
...
export default class Zoom extends Component {
  ...
  render() {
    ...
    console.log("meetingCreated:",meetingCreated)
    return (
